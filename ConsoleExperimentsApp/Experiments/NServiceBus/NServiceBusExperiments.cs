...
namespace ConsoleExperimentsApp.Experiments.NServiceBus
{
    ...
    public class PlaceOrderCommand : global::NServiceBus.ICommand
    {
    ...
    public class CancelOrderCommand : global::NServiceBus.ICommand
    {
        public Guid OrderId { get; set; }
